...
for iter in range(5):
    ...
    df['iter_' + str(iter) + 'torch_median_accuracy'] = torch_med_list
    df['iter_' + str(iter) + 'torch_time'] = torch_time_list
    df['iter_' + str(iter) + 'colab_accuracy'] = colab_acc_list
    df['iter_' + str(iter) + 'colab_time'] = colab_time_list
